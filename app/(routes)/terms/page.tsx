     ...
     <div className="min-h-screen w-full">
       ...
       <main className="mx-auto max-w-3xl px-4 py-10">
         ...
         <section className="mt-8 space-y-3">
           ...
           <p>
             Do not misuse the service, attempt to circumvent limitations, or engage in prohibited
         ...
         <section className="mt-8 space-y-3">
           ...
           <p>
             For questions about these Terms, contact the Flowkit team via the feedback option in
             the app or the channels listed on our site.
           </p>
         </section>
       </main>
     </div>
